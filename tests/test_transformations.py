...
def test_get_dens_vel():
    assert _get_dens_vel(1.5, 1.0, 5/3, 1, -1, 0.1, 0.1, 0.2, 1)   == approx((1.5203929892776895, 0.09983362447771839, 0.013468458590558391))
    assert _get_dens_vel(0.2, 1.0, 5/3, 1, -1, 0.1, 0.1, 0.2,   1) == approx((3.9263942235163563, -0.29038210913525486, -0.019677575285259364))
    assert _get_dens_vel(1.5, 1.0, 5/3, 1, -1, 0.1, 0.1, 0.2, 0.5) == approx((1.3738301513856814, 0.09239015780274291, 0.01246426763579161))
    assert _get_dens_vel(0.2, 1.0, 5/3, 1, -1, 0.1, 0.1, 0.2, 0.5) == approx((5.871328816729225, -0.37299792971384055, -0.025275988472730864))